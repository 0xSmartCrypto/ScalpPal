...
function App() {
  ...
  useEffect(() => {
    terra.market.swapRate(new Coin('uluna', 10000), 'uusd')
      .then((result) => {
        const priceOfLuna = result.amount.d[0] / 10000;
        // console.info('LUNA price', priceOfLuna, 'usd');
        setPriceLuna(priceOfLuna);
      });
  }, []);
